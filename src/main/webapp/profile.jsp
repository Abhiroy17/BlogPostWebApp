...
<html>
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <a class="navbar-brand" href="index.jsp"> <i class="fab fa-blogger"></i> Let's Blog
            </a>
                    ...
                    <!-- <li class="nav-item dropdown"><a
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="#"><i
                                    class="fas fa-digital-tachograph"></i>Technical</a> <a
                                class="dropdown-item" href="#"><i class="fas fa-tshirt"></i>Fashion</a> <a
                                class="dropdown-item" href="#"><i class="fas fa-utensils"></i>Food</a> <a class="dropdown-item"
                                href="#"><i class="fas fa-bus"></i>Travel</a>
